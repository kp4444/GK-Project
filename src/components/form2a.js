              ...
              <Row className="clearfix">
                <Col sm={2}>
                  <Nav bsStyle="pills" stacked>
                   <NavItem eventKey="first">Section A</NavItem>
                          ...
                          <Col xs={400} md={1000}>
                            <section className='add-item'>
                              ...
                              <form onSubmit={this.handleSubmit}>
                                <p>Facility Name</p>
                                    <input type="text" color="red" name="facilityName" placeholder="What's your Facility name" onChange={this.handleChange} value={this.state.facilityName} />
                                 <p>Mailing Address</p>
                                  ...
                                  <FlexRow> <button style={{ width: "125px"}}>Add sample
                                            </button>
                              ...
                              >
                                ...
                                >
                                  <span className="cls_009">
                                    ...
                                    Standards under 40 Code of Federal Regulations (CFR) 403.6 
                                  </span>
                                </div>
                                <div
                                ...
                                <div
                                  style={{ position: "absolute", left: "41.42px", top: "665.62px" }}
                                  className="cls_005"
                                >
