  ...
  render() {
    ...
    <Tabs defaultActiveKey={1} id="uncontrolled-tab-example">
      ...
      <Tab eventKey={2} title="Permits FAQ">
        ...
        <div style={{position: 'absolute', left: '50%', marginLeft: '-306px', top: 0, width: 612, height: 792, borderStyle: 'outset', overflow: 'hidden'}}>
          <div style={{position: 'absolute', left: 0, top: 0}}>
            <img src="backgroundPhotos/background01.jpg" width={612} height={792} /></div>
          <div style={{position: 'absolute', left: '259.92px', top: '70.68px'}} className="cls_002"><span className="cls_002">Disclaimer</span></div>
          <div style={{position: 'absolute', left: '115.62px', top: '134.64px'}} className="cls_003"><span className="cls_003">This is an updated PDF document that allows you to type your information</span></div>
          <div style={{position: 'absolute', left: '115.62px', top: '148.44px'}} className="cls_003"><span className="cls_003">directly into the form, print it, and save the completed form.</span></div>
          <div style={{position: 'absolute', left: '115.62px', top: '176.04px'}} className="cls_003"><span className="cls_003">Note: This form can be viewed and saved only using Adobe Acrobat Reader</span></div>
          <div style={{position: 'absolute', left: '115.62px', top: '189.84px'}} className="cls_003"><span className="cls_003">version 7.0 or higher, or if you have the full Adobe Professional version.</span></div>
          <div style={{position: 'absolute', left: '115.62px', top: '217.44px'}} className="cls_003"><span className="cls_003">Instructions:</span></div>
          <div style={{position: 'absolute', left: '133.62px', top: '231.24px'}} className="cls_003"><span className="cls_003">1.  Type in your information</span></div>
          <div style={{position: 'absolute', left: '133.62px', top: '245.04px'}} className="cls_003"><span className="cls_003">2.  Save file (if desired)</span></div>
          <div style={{position: 'absolute', left: '133.62px', top: '258.84px'}} className="cls_003"><span className="cls_003">3.  Print the completed form</span></div>
          <div style={{position: 'absolute', left: '133.62px', top: '272.64px'}} className="cls_003"><span className="cls_003">4.  Sign and date the printed copy</span></div>
          <div style={{position: 'absolute', left: '133.62px', top: '286.44px'}} className="cls_003"><span className="cls_003">5.  Mail it to the directed contact.</span></div>
        </div>
        <div style={{position: 'absolute', left: '50%', marginLeft: '-306px', top: 802, width: 612, height: 792, borderStyle: 'outset', overflow: 'hidden'}}>
          <div style={{position: 'absolute', left: 0, top: 0}}>
        ...
        <div style={{position: 'absolute', left: '50%', marginLeft: '-306px', top: 1604, width: 612, height: 792, borderStyle: 'outset', overflow: 'hidden'}}>
          <div style={{position: 'absolute', left: 0, top: 0}}>
